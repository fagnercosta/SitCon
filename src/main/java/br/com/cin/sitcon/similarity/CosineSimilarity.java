package br.com.cin.sitcon.similarity;
...
public class CosineSimilarity
{
    ...
    {
        CosineSimilarity cosseno = new CosineSimilarity();
        double sim_score = cosseno.Cosine_Similarity_Score("Promover conectividade entre todos os campi do IF",
        		"Promover conectividade entre todos os campi do IF");
